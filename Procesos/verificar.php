	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="jumbotron">
				...
				<p>
					Te damos oficialmente la vienvenida al sistema AgroIniap,<br>
                    por favor accede al sistema.
				</p>
				<p>
					<a class="btn btn-primary btn-large" href="http://localhost/AgroIniap/Login/login.php">Empezar</a>
				</p>
			</div>
		</div>
		<div class="col-md-4">
